...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        selectHighlighted: function (options) {
            ...
            var id = $('div.allSelect2.lastOpened').attr('id');
            console.log(id);
            if (data) {
                if (data.id !== -1) {
                    if (data) {
...
//            }
    ...
    $.fn.select2.defaults = {
        ...
        formatMatches: function (matches) {
            return matches + " resultats disponibles, veuillez utiliser et les touches fléchées pour naviguer.";
        ...
        formatInputTooShort: function (input, min) {
            ...
            return "Veuillez entrer " + n + " ou plus de caractère" + (n == 1 ? "" : "s");
        },
        formatInputTooLong: function (input, max) {
            var n = input.length - max;
            return "Veuillez supprimer " + n + " caractère" + (n == 1 ? "" : "s");
        }, //Please delete " + n + " character"
        formatSelectionTooBig: function (limit) {
            return "Vous pouvez selectionner seulement " + limit + " élément" + (limit == 1 ? "" : "s");
        }, //You can only select " + limit + " item"

...
(function (factory) {
    ...
    $.extend(altEditor.prototype, {
        ...
        _openEditModal: function () {
            ...
            $('#altEditor-modal input').eq(0).focus();
        ...
        _editRowData: function () {
            ...
            var url = this._getExecutionLocationFolder() + 'php/update.php';

            $('#altEditor-modal .modal-body .alert').remove();

            $.ajax(
                {
                    data: $('form[name="altEditor-form"]').serialize(),
                    dataType: "json",
                    url: url,
                    type: "POST",
                 ...
                 <strong>Oh no!</strong> Change some things and try again.\
               </div>';
        ...
        _deleteRow: function () {
            ...
            var url = this._getExecutionLocationFolder() + 'php/delete.php';
            ...
            $.ajax(
                {
                 ...
                 <strong>Success!</strong> This record has been deleted.\
                    ...
                    error: function (xhr, status, error) {
                        var message = '<div class="alert alert-danger" role="alert">\
                 <strong>Oh no!</strong> Something happened. This record still exists.\
               </div>';
        ...
        _addRowData: function () {
            ...
            var url = this._getExecutionLocationFolder() + 'php/add.php';

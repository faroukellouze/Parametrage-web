 ...
 */
/*! SmartAdmin - v1.4.1 - 2014-06-26 */function SmartUnLoading() {
...
$.bigBox = function(a, b) {
    var c;
    if (a = $.extend({title: "", content: "", icon: void 0, number: void 0, color: void 0, sound: $.sound_on, sound_file: "bigbox", timeout: void 0, colortime: 1500, colors: void 0}, a), 1 == a.sound && 0 == isIE8orlower()) {
...
$.smallBox = function(a, b) {
    var c;
    if (a = $.extend({title: "", content: "", icon: void 0, iconSmall: void 0, sound: $.sound_on, sound_file: "smallbox", color: void 0, timeout: void 0, colortime: 1500, colors: void 0}, a), 1 == a.sound && 0 == isIE8orlower()) {
        var d = document.createElement("audio");
        navigator.userAgent.match("Firefox/") ? d.setAttribute("src", $.sound_path + a.sound_file + ".ogg") : d.setAttribute("src", $.sound_path + a.sound_file + ".mp3"), $.get(), d.addEventListener("load", function() {
            d.play()
        }, !0), $.sound_on && (d.pause(), d.play())

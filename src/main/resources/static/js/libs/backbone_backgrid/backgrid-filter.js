...
(function (root, factory) {
    ...
    var ServerSideFilter = Backgrid.Extension.ServerSideFilter = Backbone.View.extend({
        ...
        template: _.template('<input class="form-control" id="search" style="width: 200px;" type="search" <% if (placeholder) { %> placeholder="<%- placeholder %>" <% } %> name="<%- name %>" <% if (value) { %> value="<%- value %>" <% } %>/>', null, {variable: null}),
